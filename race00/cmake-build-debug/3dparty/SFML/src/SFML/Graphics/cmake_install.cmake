...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xbinx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES
    "/Users/snikolayen/mm/race00/cmake-build-debug/3dparty/SFML/lib/libsfml-graphics-d.2.5.1.dylib"
    "/Users/snikolayen/mm/race00/cmake-build-debug/3dparty/SFML/lib/libsfml-graphics-d.2.5.dylib"
    )
  foreach(file
    ...
    if(EXISTS "${file}" AND
      ...
      execute_process(COMMAND /usr/bin/install_name_tool
        ...
        "${file}")
      execute_process(COMMAND /usr/bin/install_name_tool
        -delete_rpath "/Users/snikolayen/mm/race00/cmake-build-debug/3dparty/SFML/lib"
        "${file}")
      execute_process(COMMAND /usr/bin/install_name_tool
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xbinx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/Users/snikolayen/mm/race00/cmake-build-debug/3dparty/SFML/lib/libsfml-graphics-d.dylib")
